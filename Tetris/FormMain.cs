...
namespace CursPI
{
    public partial class FormMain : Form
    {
        ...
        private void buttonRegistrate_Click(object sender, EventArgs e)
        {
            ...
            {
                if (textBoxNewLogin.Text.Length < 9 && textBoxNewLogin.Text.Length > 3)
                {
                    ...
                    if (isCorrect)
                    {
                        ...
                        {
                            MessageBox.Show("Длина пароля должна составлять не менее 4 и не более 10 символов");
                            textBoxNewPassword.Clear();
                            textBoxCheckPassword.Clear();
                        }
                    }
                ...
                {
                    MessageBox.Show("Длина логина должна составлять не менее 4 и не более 8 символов");
                    textBoxNewLogin.Clear();
                    textBoxNewPassword.Clear();
                    textBoxCheckPassword.Clear();
                }
